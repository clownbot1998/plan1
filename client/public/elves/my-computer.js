    ...
    body: (target) => `
      <div style="display:flex;flex-direction:column;height:100%">
        <div style="display:flex;gap:.4rem;padding:.4rem .8rem;background:#111;flex-shrink:0">
          ...
          <button data-coding-tab="tty" style="font-family:'Recursive',monospace;font-size:1.2rem;padding:.2rem .8rem;background:transparent;border:1px solid #3c3c3c;color:#d4c5a9;cursor:pointer">tty</button>
        ...
        <div data-coding-panel="tty" style="flex:1;min-height:0;display:none"><tty-elf></tty-elf></div>
